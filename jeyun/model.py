...
class E5Retriever:
    def __init__(self, model_name=None, device=None):
        """
        Initializes the E5 retriever using the multilingual E5 large model.
        """
        # Use local model
...
def preprocess(corpus_dict):
    ...
    translated_passages = translator.translate(original_passages, src_lang="he", tgt_lang="en", batch_size=16)
