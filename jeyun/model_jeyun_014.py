...
class Translator:
    def __init__(self, model_name=None, device=None):
        ...
        if model_name is None:
            local_model_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'models', 'english-hebrew')
...
def preprocess(corpus_dict):
    ...
    translated_passages = translator.translate(original_passages, src_lang="he", tgt_lang="en", batch_size=256)
