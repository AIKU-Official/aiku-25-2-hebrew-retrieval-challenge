...
try:
    ...
    print("Error: Could not import preprocess/predict from model_ju.py.", file=sys.stderr)
    print("Ensure model_ju.py is in the same directory.", file=sys.stderr)
    sys.exit(1)
